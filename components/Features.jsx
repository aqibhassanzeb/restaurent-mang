...
const Features = () => {
  return (
    <div className="mb-5 overflow-hidden bg-white md:mb-0 md:p-10 z-1">
          ...
          <div className="container px-6 py-12 mx-auto">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div>
                ...
                <Image
                  src="https://www.svgrepo.com/show/270123/dish-meal.svg"
                  alt="icon"
                  width={100}
                  height={100}
                />
                ...
                <p className="mt-2 text-gray-500 dark:text-gray-400">
                  Our professional chefs cook delicious meals and we deliver
                  them fresh to you.We offer delicious, chef-curated meals
              ...
              <div>
                ...
                <Image
                  src="https://www.svgrepo.com/show/313332/fast-delivery.svg"
                  alt="icon"
                  width={100}
                  height={100}
                />
                ...
                <p className="mt-2 text-gray-500 dark:text-gray-400">
                  Your lightning-fast delivery partner. Nothing can slow us
                  down. On-demand last-mile delivery Its on time or its on us.
                </p>
              </div>
              ...
              <div>
                ...
                <Image
                  src="https://www.svgrepo.com/show/44354/take-away.svg"
                  alt="icon"
                  width={100}
                  height={100}
                />
                ...
                <p className="mt-2 text-gray-500 dark:text-gray-400">
                  Aamir Restuarant offers you the best parcel and courier
                  delivery service We deliver secure end to end tamper proof
                  deliver.
                </p>
              </div>
            </div>
